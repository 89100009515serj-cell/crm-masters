...
import { searchRequests, ARCHIVE_STATUSES, type SortKey } from "@/server-actions/search-requests";
    ...
    <>
      ...
      <main className="p-8 max-w-7xl mx-auto">
        <div className="flex items-center justify-between mb-4">
          <div>
            <h1 className="text-2xl font-semibold text-slate-900">Архив заявок</h1>
            <p className="text-sm text-slate-500">Завершённые и отменённые — только просмотр</p>
          </div>
          <Link
            href="/requests"
